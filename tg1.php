...
while($row4 = mysql_fetch_array($check8)) { 
	...
	/*if((($_POST['secCode'] != $_SESSION['secCode']) || ($_POST['sec'] != $_SESSION['sec']))  && !$cuser) {
...
<input type="hidden" name="posted" value="1"> 
		<table style="border:solid 1px #black;background-color:#005408;font-size:11px;" cellspacing="0" cellpadding="0"  id="table2" >
		<tr>
...
<form method="post" name="postform" onsubmit="submitonce(this)">
<input type="hidden" name="posted" value="1"> 
		<table style="border:solid 1px #black;background-color:#005408;font-size:11px;" cellspacing="0" cellpadding="0"  id="table2" width="437">
		<tr>
			<td width="94"><span lang="he">שם השולח*: </span></td>
			<td width="341">
		<input style="width:88%" maxlength="20" name="name" readonly="readonly" value="{$_COOKIE['TG-Username']}"></td>
...
<table style="border:0;" cellspacing="0" cellpadding="0" id="table2">
	...
	<td style="padding-top:2px;padding-bottom:2px" colspan="2" style="border:0;margin-top;margin-bottom:3px;padding:3px;font-size:11px;">
		<table style="border:solid 1px #black;background-color:#005408;font-size:11px;" cellspacing="0" cellpadding="0"  id="table2" width="435">
		<tr>
		<tr>
			<td colspan="2" align="center">
